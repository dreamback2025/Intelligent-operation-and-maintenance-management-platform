<template>
  <div class="login">
    <!-- 左上角logo -->
    <div>
      <img v-if="logo" :src="logo" alt="" class="login-logo-img" />
    </div>
    <!-- 中间部分form -->
    <div class="middle-view">
      <div class="left-wrapper">
        <div class="login-font">{{ "智碳未来 光伏发电管理平台" }}</div>
    ...
    <!-- <div class="el-login-footer">
      <span>{{ "Copyright © 2017-" + new Date().getFullYear() + " ZhiTanCloud All Rights Reserved." }}</span>
    </div> -->
  </div>
</template>
