...
CREATE TABLE `device_type_template`  (
                                         ...
                                         `name` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '璁惧绫诲瀷鍚嶇О',
                                         `description` varchar(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '璁惧鎻忚堪',
                                         `remark` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '澶囨敞',
                                         `create_time` datetime NULL DEFAULT NULL COMMENT '鍒涘缓鏃堕棿',
                                         `create_by` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '鍒涘缓浜?,
                                         `update_time` datetime NULL DEFAULT NULL COMMENT '淇敼鏃堕棿',
                                         `update_by` varchar(36) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '淇敼浜?,
                                         PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '璁惧绫诲瀷绠＄悊' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `gen_table`  (
                              ...
                              `gen_type` char(1) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT '0' COMMENT '鐢熸垚浠ｇ爜鏂瑰紡锛?zip鍘嬬缉鍖?1鑷畾涔夎矾寰勶級',
...
) ENGINE = InnoDB AUTO_INCREMENT = 13 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '浠ｇ爜鐢熸垚涓氬姟琛? ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `gen_table_column`  (
                                     ...
                                     `is_pk` char(1) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '鏄惁涓婚敭锛?鏄級',
                                     `is_increment` char(1) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '鏄惁鑷锛?鏄級',
                                     `is_required` char(1) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '鏄惁蹇呭～锛?鏄級',
                                     `is_insert` char(1) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '鏄惁涓烘彃鍏ュ瓧娈碉紙1鏄級',
                                     `is_edit` char(1) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '鏄惁缂栬緫瀛楁锛?鏄級',
                                     `is_list` char(1) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '鏄惁鍒楄〃瀛楁锛?鏄級',
                                     `is_query` char(1) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '鏄惁鏌ヨ瀛楁锛?鏄級',
...
) ENGINE = InnoDB AUTO_INCREMENT = 136 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '浠ｇ爜鐢熸垚涓氬姟琛ㄥ瓧娈? ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `device_type`  (
                                ...
                                `name` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '鍚嶇О',
                                `remark` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '澶囨敞',
                                `description` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '鎻忚堪',
...
CREATE TABLE `spare_parts_record`  (
                                       `id` varchar(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
                                       `code` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '缂栧彿',
                                       `name` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '鍚嶇О',
                                       `specs` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '瑙勬牸鍨嬪彿',
                                       `power_station_id` varchar(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT '' COMMENT '鐢电珯id',
                                       `power_station_name` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '鍑哄叆搴撳埌鐢电珯鍚嶇О',
                                       `amount` int NOT NULL DEFAULT 0 COMMENT '鎿嶄綔鏁伴噺',
                                       `status` char(1) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '0' COMMENT '鐘舵€侊紙0鍏ュ簱锛?鍑哄簱锛?,
                                       `remark` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '澶囨敞',
                                       `create_time` datetime NULL DEFAULT NULL COMMENT '鍒涘缓鏃堕棿',
                                       `create_by` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '鍒涘缓浜?,
                                       `update_time` datetime NULL DEFAULT NULL COMMENT '淇敼鏃堕棿',
                                       ...
                                       `user_id` bigint NULL DEFAULT NULL COMMENT '鐢ㄦ埛id',
                                       `dept_id` bigint NULL DEFAULT NULL COMMENT '閮ㄩ棬id',
                                       `location` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '搴撳瓨鍦扮偣',
                                       `location_id` bigint NULL DEFAULT NULL COMMENT '搴撳瓨鍦扮偣id',
                                       `movement_date` date NULL DEFAULT NULL COMMENT '鍑哄叆搴撴棩鏈?,
                                       PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '澶囧搧澶囦欢-鎿嶄綔璁板綍琛? ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `spare_parts`  (
                                ...
                                `specs` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '瑙勬牸鍨嬪彿',
                                `power_station_id` varchar(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT '' COMMENT '鐢电珯id',
                                `power_station_name` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '鐢电珯鍚嶇О',
                                ...
                                `location_id` bigint NULL DEFAULT NULL COMMENT '搴撳瓨鍦扮偣id',
                                PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '澶囧搧澶囦欢' ROW_FORMAT = DYNAMIC;
